---
title: "Clustering NOCss based on ONET skills"
format:
  html:
...
```{r, include=FALSE}
set.seed(1234)
cluster_names <- tibble::tibble(cluster_number=as.character(1:11), 
...
corrected_res <- corrected_ave%>%
  ...
  prcomp()
ggbiplot::ggbiplot(corrected_res, labels = corrected_ave$new_cluster, varname.size = 1.5, var.scale = .5, labels.size = 2)+
  theme_minimal()
```
